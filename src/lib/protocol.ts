export type WebSocketClientMessage =
  | { type: "join_queue"; userId: string; displayName: string; lat: number; lng: number; radius: number }
...
export type WebSocketServerMessage =
  ...
  | { type: "queue_left" }
  | { type: "match_found"; matchId: string; distanceMeters: number; partner: { userId: string; displayName: string } }
